...
abstract class L10n {
  ...
  /// No description provided for @fluffyChatSupportBannerMessage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @skipSupportingFluffyChat.
  ///
  /// In en, this message translates to:
  /// **'Skip supporting FluffyChat'**
  String get skipSupportingFluffyChat;

  /// No description provided for @iDoNotWantToSupport.
  ///
  /// In en, this message translates to:
  /// **'I do not want to support'**
  String get iDoNotWantToSupport;

  /// No description provided for @iAlreadySupportFluffyChat.
  ///
  /// In en, this message translates to:
  /// **'I already support FluffyChat'**
  String get iAlreadySupportFluffyChat;
