...
enum AppSettings<T> {
  ...
  logoUrl<String>('xyz.plusly.logo_url', 'https://mtux.nl/logo.svg'),
  privacyPolicy<String>('xyz.plusly.privacy', 'https://mtux.nl/privacy'),
  tos<String>('xyz.plusly.tos', 'https://mtux.nl/terms'),
  website<String>('xyz.plusly.website', 'https://mtux.nl'),
