...
/// Optimized Message widget that uses UserCache to avoid
...
class _MessageOptimizedState extends State<MessageOptimized> {
  ...
  // Use UserCache instead of FutureBuilder
  User? _cachedUser;
  ...
  /// Calculates the width of the media content
