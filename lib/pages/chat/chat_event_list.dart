...
class ChatEventList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Use ListView.custom (FluffyChat-style) instead of CustomScrollView +
    // SliverList. A single ListView with findChildIndexCallback keeps the
    // scroll position stable when new events arrive, because widgets are
    // matched by their ValueKey eventId instead of by index.
    return ListView.custom(
      ...
      padding: EdgeInsets.only(
        top: AppSettings.enableChatFrostedGlass.value
            ...
            : 16,
        bottom: 8 + controller.inputBarHeight.value,
        left: horizontalPadding,
        right: horizontalPadding,
      ),
      childrenDelegate: SliverChildBuilderDelegate(
        (BuildContext context, int i) {
          // i == 0 is the visual bottom footer (typing indicators / load more).
          if (i == 0) {
